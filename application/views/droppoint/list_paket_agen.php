        ...
        <div class="box-body">
          <form method="post" action="<?php echo site_url('droppoint/multi_kirim_paket_agen'); ?>">
            ...
            <div class="box-header with-border">
              <div>
                <a href="<?= base_url(); ?>droppoint/list_transaksi_agen/" class="btn btn-default"><i class="fa fa-history"></i> Riwayat Transaksi AGEN => DP</a>
                <a href="<?= base_url(); ?>droppoint/list_transaksi_dp_kirim/" class="btn btn-default"><i class="fa fa-history"></i> Riwayat Transaksi DP => DP</a>
              </div>
            </div>
            <div class="row">
