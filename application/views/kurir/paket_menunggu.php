              ...
              <table class="table table-bordered table-hover dt-responsive nowrap" id="datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="<?= base_url(); ?>kurir/ambil_paket/<?= $key->no_resi; ?>/<?= $key->status_transaksi; ?>" class="btn btn-warning btn-xs" onclick="return confirm('Anda Yakin ?');"><i class="fa fa-plus"></i> Ambil</a>
                    </td>
                    <td>
