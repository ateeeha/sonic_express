...
<div class="wrapper">
    ...
    <a href="<?= base_url(); ?>admin/" class="logo">
      ...
      <span class="logo-mini"><b>L</b><?= ucfirst($this->session->userdata('level')); ?></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Level</b><?= ucfirst($this->session->userdata('level')); ?></span>
    </a>
        ...
        <ul class="nav navbar-nav navbar-center">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-user"></i> <?= ucfirst($this->session->userdata('username')); ?>
            </a>
            <ul class="dropdown-menu">
              
              <li class="divider"></li>
              <li><a href="<?= base_url(); ?>index.php/member/logout/" class="fa fa-sign-out"> Keluar</a></li>
            </ul>
          </li>
        </ul>
      </div>
