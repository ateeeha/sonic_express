              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                    <input type="text" class="form-control col-md-7 col-xs-12" name="username" readonly value="<?= $id_dp; ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4 col-sm-6">
                    <select name="status" class="form-control">
                        ...
                        <option value="1" <?php if ($status_dp == 1) { echo "selected";} ?>>Tidak Aktif</option>
                        <option value="2" <?php if ($status_dp == 2) { echo "selected";} ?>>Aktif</option>
                    </select>
                  </div>
                </div>
                <hr>
